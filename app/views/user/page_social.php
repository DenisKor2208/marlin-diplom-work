<?php $this->layout('templates/template', ['title' => 'Social']) ?>
...
<main id="js-page-content" role="main" class="page-content mt-3">
    ...
    <form action="/page-social" method="post">
        <div class="row">
            <div class="col-xl-12">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                        ...
                                        <input type="text" class="form-control border-left-0 bg-transparent pl-0" name="user_vk_link" value="<?php echo $userData[0]['user_vk_link']?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <!-- telegram -->
                                    <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                        ...
                                        <input type="text" class="form-control border-left-0 bg-transparent pl-0" name="user_telegram_link" value="<?php echo $userData[0]['user_telegram_link']?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <!-- instagram -->
                                    <div class="input-group input-group-lg bg-white shadow-inset-2 mb-2">
                                        ...
                                        <input type="text" class="form-control border-left-0 bg-transparent pl-0" name="user_instagram_link" value="<?php echo $userData[0]['user_instagram_link']?>">
                                    </div>
                                </div>

<?php $this->layout('templates/template', ['title' => 'Безопаность']) ?>
...
<main id="js-page-content" role="main" class="page-content mt-3">
    ...
    <form action="/page-security-email" method="post">
        <div class="row">
            <div class="col-xl-6">
                    ...
                    <div class="panel-container">
                        ...
                        <div class="panel-content">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="simpleinput" class="form-control" name="email" value="<?php echo $userData[0]['email']?>">
                            </div>

                            <div class="col-md-12 mt-3 d-flex flex-row-reverse">
                                <button class="btn btn-warning">Изменить эл. адрес</button>
                            </div>
                        </div>
                    </div>
    ...
    <form action="/page-security-password" method="post">
        <div class="row">
            <div class="col-xl-6">
                <div id="panel-1" class="panel">
                    <div class="panel-container">
